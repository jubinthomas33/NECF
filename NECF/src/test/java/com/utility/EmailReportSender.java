...
public class EmailReportSender {
    ...
    // =====================================================
    private static final String RECIPIENTS = String.join(",",
            ConfigReader.getProperty("recipient1"),
            ConfigReader.getProperty("recipient2")
    );

    private static final String FROM_EMAIL = ConfigReader.getProperty("email");
    private static final String APP_PASSWORD = ConfigReader.getProperty("password");

    public static void sendFailureReportWithScreenshots(List<String> failedScenarios,
                                                        List<String> failedScreenshots) {
